...
1) Install zsh and set it as your login shell:
    ...
    bash <(wget -qO- https://raw.github.com/mllm/laptop/master/linux-prerequisites)
...
Read, then run the script:
    ...
    zsh <(curl -s https://raw.github.com/mllm/laptop/master/mac)

### Linux

Read, then run the script:

    zsh <(wget -qO- https://raw.github.com/mllm/laptop/master/linux)
